...
@property (nonatomic, readonly, retain) NSDictionary *nodes;
...
@property (nonatomic, readonly, retain) NSDictionary *edges;
...
@property (nonatomic, readonly, retain) NSDictionary *adjacency;
...
@property (nonatomic, readonly, retain) NSDictionary *names;
