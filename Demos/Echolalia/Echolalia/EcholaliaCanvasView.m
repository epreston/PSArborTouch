...
@implementation EcholaliaCanvasView
...
- (void) drawRect:(CGRect)rect
{
    if ( self.system ) {
        ...
        CGContextSetRGBStrokeColor(context, 1.0, 1.0, 1.0, 1.0); // white line
        CGContextSetLineWidth(context, 1.0);
        ...
        CGContextSetRGBStrokeColor(context, 1.0, 1.0, 1.0, 1.0); // white line for node box
...
- (void) drawParticleText:(ATParticle *)particle inContext:(CGContextRef)context
{
    ...
    // Expand the rect around the center
    fillRect = CGRectInset(fillRect, -10.0, -10.0);
    
    
    // Fill in the rect with current fill color
    CGContextSetRGBFillColor(context, 1.0, 1.0, 1.0, 1.0); // white fill color
    CGContextFillRect(context, fillRect);
    
//    // Set the text fill color
//    CGContextSetRGBFillColor(context, 1.0, 1.0, 1.0, 1.0); // black
//    
//    // Draw the text label
